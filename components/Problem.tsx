...
const PROBLEMS = [
  {
    ...
    text: 'С 1 января 2026 курьерские службы, таксопарки, маркетплейсы и агрегаторы официально стали налоговыми агентами для самозанятых. Невыполнение = штрафы до 200 МРП за каждый случай.',
  },
  {
    icon: Clock,
    title: 'Сроки горят',
