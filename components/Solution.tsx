      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {[
            {
              icon: Layers,
              title: 'Одна точка входа',
              big: '9 → 1',
              desc: 'Девять требований закона закрываются одним запросом. Передайте ИИН и сумму — получите однозначное решение: «можно платить», «можно с осторожностью» или «нельзя» с указанием причины.',
            ...
            },
            {
              ...
              big: '14 дней',
              desc: 'Доступ к тестовой среде — в день подписания. Тестовая интеграция — за неделю. Перевод на боевой режим — за день. Месяц активного сопровождения от нашей команды.',
            ...
            {
              icon: Shield,
              title: 'Полное соответствие закону',
              big: '100%',
              desc: 'Каждое требование закона 214-VIII закрыто. Электронный документооборот. Журнал всех операций для аудита. Гарантия доступности 99.9% по договору.',
