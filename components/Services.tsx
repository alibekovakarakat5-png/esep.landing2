...
const SERVICES = [
  {
    ...
    title: 'Выплата исполнителю',
    sub: 'Универсальный сервис. Один запрос = все проверки + чек.',
    detail: 'Передайте ИИН курьера или водителя, сумму и номер заказа (поездки). За миллисекунды: проверка ИИН, статуса, контроль месячного лимита, выдача фискального чека. В ответ — однозначное решение: «можно платить», «осторожно» или «запрещено» с указанием причины.',
    code: 'Главный сервис',
  },
  {
  ...
  },
  {
    ...
    detail: 'Накопительный счётчик доходов каждого курьера или водителя. При приближении к лимиту — предупреждение. При попытке превысить — запрет с подсказкой «исполнителю пора зарегистрироваться как ИП».',
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-6 text-lg text-navy/60 leading-relaxed">
            ...
            универсальный сервис <b>«Выплата исполнителю»</b>, который объединяет
